...
async def list_bundle_notification(context: Context) -> str:
    ...
    try:
        ...
        markdown_list = object_list_to_markdown_table(retval, ["id", "bundle_id", "notify_user_id", "notify_on_registration", "notify_on_upload"])
...
async def create_bundle_notification(context: Context, bundle_id: int | None = None, notify_user_id: int | None = None) -> str:
...
def register_tools(mcp):
    ...
    @mcp.tool()
    async def create_bundle_notification_tool(context: Context, bundle_id: int | None = None, notify_user_id: int | None = None) -> str:
        return await create_bundle_notification(context, bundle_id, notify_user_id)
